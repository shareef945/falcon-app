    ...
    return (
        <div className='body'>
            <div className='titlebar'>
                ...
                <h2>Your Personal Loan application</h2>
            </div>

            <p style={{
                marginLeft: "5%",
                marginRight: "5%",
            }}>To request this personal loan, please confirm that the details below are still correct. If any have changed, please edit as required.</p>
