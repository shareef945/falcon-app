...
export default function ProdReq4() {
    ...
    async function verifyBank() {
        ...
        if (accountNumberInput === undefined) {
            ...
            const verified = await verifyBankAccount(accountNumberInput, bankCode, `${customer["First Name"]} ${customer["Last Name"]}`);
            if (verified === true) {
                ...
                toast("We couldn't confirm that's a real account. Please try again.");
                setBanking(false);
                setWorking(false);
    ...
    return (
        <div>
            <Toaster />
            {working ?
                <BeatLoader color='orange' style={{ margin: '100px' }} /> :
                <div>
                    {count > 0 ?
                        <div className="body">
                            <Toaster />
                            {working == true ? <BeatLoader /> : <div className="row-responsive-centre-horiz">
                        ...
                        <div>
                            ...
                            <div className='titlebar'>
                                <a href="/loans/personal-loan-caclulator">  <svg xmlns="http://www.w3.org/2000/svg" className="backarrow" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>
                                </a>
                                ...
                                <div className='info-container'>
                                    ...
                                    <div className='card-align-vertical'>
                                        <div className='input-container'>
                                            ...
                                            <input 
                                            style={{padding: 16}}
                                            className="container-grey-bg" value={payoutAcc.length == 0 ? "Please verify an account" : payoutAccDescription} disabled='disabled' />
                                            {banking ?
