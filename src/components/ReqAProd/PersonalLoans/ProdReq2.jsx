...
export default function ProdReq2() {
    ...
    return (
        <div className='body'>
            ...
            <div className='titlebar'>
                ...
                <h2 className='pagetitle'>Personal loan calculator</h2>
            </div>
            <div className='row-responsive'>
                ...
                <div className='float-right-responsive'>
                    ...
                    <button
                        onClick={() => {
                            navigate('/loans/submit-personal', {
                                state: {
                                    request: {
                                        "Customer ID": customer._id,
                                        "Product ID": "PL"+customer._id.substring(0,3)+String(crypto.randomUUID(5)).substring(0,2),
                                        "Request Date": timestamp.getTime(),
                                        "Product Category": "Personal loan",
