...
import { audi, bmw, ford, toyota, hyundai, landrover, peugeot, kia, vw, mercedes, nissan, honda } from '../../utils/Cars';
...
export default function CarFinance4() {
    ...
    let makeAndModelInteractions = 0;
    ...
    // the dropdown for car make maps to the keys of the carsObject
    // the dropdown for model maps to the values of the key that the current selected make represents in carsObject

    const [selected, setSelected] = useState(options[0]);
    const [asset_make, setasset_make] = useState(Object.keys(carsObject)[0]);
    const [asset_model, setasset_model] = useState(carsObject["Any"][0]);
    ...
    requestObj["Asset Make"] = asset_make;
    requestObj["Asset Model"] = asset_model;
                ...
                <div>
                    ...
                    <div className='row-responsive'>
                        ...
                        <div className='info-container'>
                            ...
                            <div className='card-align-centre'>
                                ...
                                <Link
                                    ...
                                    to='/loans/asset-loan-calculator'>
                        ...
                        <div className='info-container'>
                            ...
                            <div className='card-align-vertical'>
                                <div className='input-container'>
                                    <p>What is the make?</p>
                                    <select className='dropdown'
                                        value={asset_make}
                                        onChange={(e) => {
                                            { setasset_make(e.target.value) }
                                        }}>
                                        {Object.keys(carsObject).map((value) => (
                                ...
                                <div className='input-container'>
                                    ...
                                    <select className='dropdown'
                                        ...
                                        onChange={(e) => {
                                            {
                                                setasset_model(e.target.value)
                                            }
                                        }}>
                                        {carsObject[asset_make].map((value) => (
                                            <option value={value} key={value}>
                                                {value}
                                            </option>
                                        ))}
                            ...
                            <div style={{
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        requestObj["Asset Make"] = asset_make;
                                        requestObj["Asset Model"] = asset_model;
                                        if (asset_make === "Any" && makeAndModelInteractions < 1) {

                                            toast.error("Are you sure about the car make and model?");

                                            makeAndModelInteractions = 1;
