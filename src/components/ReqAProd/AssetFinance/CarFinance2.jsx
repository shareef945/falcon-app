...
export default function CarFinance2() {
    ...
    return (
        <div className='body'>
            ...
            <div className='titlebar'>
                ...
                <h2 className='pagetitle'>Asset finance calculator</h2>
            </div>
            <div className='row-responsive'>
                ...
                <div className='float-right-responsive'>
                    ...
                    <button
                        onClick={() => {
                            navigate('/loans/submit-asset', {
                                state: {
                                    request: {
                                        "Customer ID": customer._id,
                                        "Product ID": "AL"+customer._id.substring(0,3)+String(crypto.randomUUID(5)).substring(0,2),
                                        "Request Date": timestamp.getTime(),
                                        "Product Category": "Asset finance",
